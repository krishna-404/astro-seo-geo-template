...
every content page front-loads its answer, the one
[GEO lever with real evidence behind it](/blog/writing-content-answer-engines-cite).
If frontmatter is wrong, the build fails. That is the feature.
